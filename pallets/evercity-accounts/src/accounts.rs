...
#[derive(Encode, Decode, Clone, Default, RuntimeDebug, MaxEncodedLen, TypeInfo)]
pub struct AccountStruct<Moment: MaxEncodedLen> {
    pub roles: RoleMask,
    #[codec(compact)]
    pub identity: u64,
    #[codec(compact)]
...
impl<Moment: MaxEncodedLen> AccountStruct<Moment> {
