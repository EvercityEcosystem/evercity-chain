...
pub(crate) fn create_user_with_owner_role() -> u64 {
    ...
    let _ = EvercityAccounts::account_add_with_role_and_data(Origin::signed(ROLES[0].0), new_owner_id, pallet_evercity_accounts::accounts::CC_PROJECT_OWNER_ROLE_MASK, 0);
    new_owner_id
}
